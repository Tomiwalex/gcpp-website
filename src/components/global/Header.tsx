...
const Header = () => {
  ...
  return (
    <header className="sticky -top-12 bg-[#14120F]">
      <div className="mx-auto w-full max-w-[1512px]">
        <div className="flex items-center justify-end gap-x-6 border-b-[0.8px] border-b-[#1E1E1E] px-5 py-3 font-normal text-[#ACACAC]">
          <Link
            href="#"
